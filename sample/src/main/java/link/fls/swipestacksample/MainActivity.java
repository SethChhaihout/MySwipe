...
import link.fls.swipestacksample.fragments.PhotoFragment;
    ...
    public class SwipeStackAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            if (convertView == null) {
                ...
                ((AppCompatActivity)convertView.getContext()).getSupportFragmentManager().beginTransaction()
                        .replace(convertView.findViewById(R.id.container).getId(),new PhotoFragment())
                        .commit();
            }
